...
class Ultraman extends UltramanBean
{
    ...
    public function getDataAnalysisByDepositBase()
    {
        ...
        $condition = [
            ...
            ['where' => ['>=' => 400000, '<' => 600000], 'color' => '#1890FF', 'type' => '400k-600k'],
            ['where' => ['>=' => 600000], 'color' => '#2FC25B', 'type' => '600k及以上']
        ];
    ...
    public function getDataAnalysisByAims()
    {
        ...
        $endTime = date('Y-12-31 23:59:59');
        $condition = [
            ['where' => ['>=' => 0, '<' => 200000], 'color' => '#223273', 'type' => '0-200k'],
            ['where' => ['>=' => 200000, '<' => 400000], 'color' => '#13C2C2', 'type' => '200k-400k'],
            ['where' => ['>=' => 400000, '<' => 600000], 'color' => '#FACC14', 'type' => '400k-600k'],
            ['where' => ['>=' => 600000, '<' => 800000], 'color' => '#1890FF', 'type' => '600k-800k'],
            ['where' => ['>=' => 800000], 'color' => '#2FC25B', 'type' => '800k及以上']
        ];
        $response['data'] = [];
        $response['color'] = [];
        for ($i = 0; $i < count($condition); $i++) {
